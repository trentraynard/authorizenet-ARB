<?php
/*
Class created to use authorize.net ARB API calls to create subscribions for cart
...
// set login and merchant transkey in config
    private $login;
    private $transkey;
    private $test;
...
/*my sandbox login for test
    define ('login' , '85jXAT3u5Psn');
    define ('transkey' , '7r9K6N922xGc34m4');
    */